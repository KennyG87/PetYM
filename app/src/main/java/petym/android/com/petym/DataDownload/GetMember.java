...
public class GetMember extends AsyncTask<Object, Integer,Member> {
    private final static String TAG = "GetMember";
    private static String ACTION = "GetMember";
    private ProgressDialog progressDialog;
    private Activity activity;
    public GetMember(Activity a,String ACTION)
    {
        this.activity = a;
        this.ACTION = ACTION;
    }
    ...
    protected Member doInBackground(Object... params) {
        ...
        Log.d("jsonIn: ", "jsonInLogin: " + jsonIn);
//        Gson gson = new Gson();
        Gson gson=  new GsonBuilder().setDateFormat("yyyy-MM-dd HH:mm:ss").create();

        return gson.fromJson(jsonIn,Member.class);

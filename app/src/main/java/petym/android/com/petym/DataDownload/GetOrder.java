...
public class GetOrder extends AsyncTask<Object, Integer,OrderVO> {
    private final static String TAG = "GetOrder";
    private static String ACTION = "GetOrder";
    private ProgressDialog progressDialog;
    private Activity activity;
    public GetOrder(Activity a,String ACTION)
    {
        this.activity = a;
        this.ACTION = ACTION;
    }
    ...
    @Override
    protected OrderVO doInBackground(Object... params) {
        String jsonIn;
...
//        Gson gson = new Gson();
            ...
            return gson.fromJson(jsonIn,OrderVO.class);
    ...
    @Override
    protected void onPostExecute(OrderVO orderVO) {

        super.onPostExecute(orderVO);
